...
<Project Type="Project" LVVersion="13008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="abortDriver_Feng.vi" Type="VI" URL="../subVIs/Drivers/abortDriver_Feng.vi"/>
			<Item Name="Arrange Array.vi" Type="VI" URL="../subVIs/toolpath/Arrange Array.vi"/>
			...
			<Item Name="configureA.vi" Type="VI" URL="../subVIs/configureA.vi"/>
			<Item Name="configureB.vi" Type="VI" URL="../subVIs/configureB.vi"/>
			<Item Name="Cypher Lithography 2.0_Feng.vi" Type="VI" URL="../subVIs/Drivers/Cypher Lithography 2.0_Feng.vi"/>
			<Item Name="cypher read value.vi" Type="VI" URL="../subVIs/Drivers/cypher read value.vi"/>
			<Item Name="Cypher XY LVDT Parameters.vi" Type="VI" URL="../subVIs/Drivers/Cypher XY LVDT Parameters.vi"/>
			<Item Name="Discard One Character.vi" Type="VI" URL="../subVIs/parsing/Discard One Character.vi"/>
			<Item Name="Display wave.vi" Type="VI" URL="../subVIs/Drivers/Display wave.vi"/>
			<Item Name="DOMUserDefRef.dll" Type="Document" URL="DOMUserDefRef.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Estimated Time Required.vi" Type="VI" URL="../subVIs/mathematics/Estimated Time Required.vi"/>
			<Item Name="funnels to Commands.vi" Type="VI" URL="../subVIs/toolpath/funnels to Commands.vi"/>
			<Item Name="GCore.vi" Type="VI" URL="../subVIs/GCore.vi"/>
			<Item Name="Get Matrix from Transform.vi" Type="VI" URL="../subVIs/parsing/Get Matrix from Transform.vi"/>
			<Item Name="Get Path Commands.vi" Type="VI" URL="../subVIs/parsing/Get Path Commands.vi"/>
			<Item Name="getIgorConversion.vi" Type="VI" URL="../subVIs/scanning/getIgorConversion.vi"/>
			<Item Name="Global Variables.vi" Type="VI" URL="../subVIs/Global Variables.vi"/>
			<Item Name="GMonitor_Fengv2.vi" Type="VI" URL="../subVIs/GMonitor_Fengv2.vi"/>
			<Item Name="igor define command.vi" Type="VI" URL="../subVIs/Drivers/igor define command.vi"/>
			<Item Name="Image Processing_Feng.vi" Type="VI" URL="../subVIs/image/Image Processing_Feng.vi"/>
			<Item Name="increment filename.vi" Type="VI" URL="../subVIs/helper VIs/increment filename.vi"/>
			<Item Name="interpolate nodes.vi" Type="VI" URL="../subVIs/Drivers/interpolate nodes.vi"/>
			<Item Name="Interpolate Points.vi" Type="VI" URL="../subVIs/mathematics/Interpolate Points.vi"/>
			<Item Name="Interpolate Points_new.vi" Type="VI" URL="../subVIs/mathematics/Interpolate Points_new.vi"/>
			<Item Name="intersection.vi" Type="VI" URL="../subVIs/mathematics/intersection.vi"/>
			<Item Name="Litho Interpolater.vi" Type="VI" URL="../subVIs/toolpath/Litho Interpolater.vi"/>
			<Item Name="Load IBW File.vi" Type="VI" URL="../subVIs/image/Load IBW File.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="Make wave.vi" Type="VI" URL="../subVIs/Drivers/Make wave.vi"/>
			<Item Name="move to target point.vi" Type="VI" URL="../subVIs/Drivers/move to target point.vi"/>
			...
			<Item Name="Paths to Commands_shicheng.vi" Type="VI" URL="../subVIs/toolpath/Paths to Commands_shicheng.vi"/>
			<Item Name="processContactData.vi" Type="VI" URL="../subVIs/helper VIs/processContactData.vi"/>
			<Item Name="Read Scan Size and Offset.vi" Type="VI" URL="../subVIs/image/Read Scan Size and Offset.vi"/>
			...
			<Item Name="Relative Coordinates.vi" Type="VI" URL="../subVIs/mathematics/Relative Coordinates.vi"/>
			<Item Name="rotation pattern.vi" Type="VI" URL="../subVIs/mathematics/rotation pattern.vi"/>
			<Item Name="Send Igor Command.vi" Type="VI" URL="../subVIs/Drivers/Send Igor Command.vi"/>
			<Item Name="Send igor command_no return.vi" Type="VI" URL="../subVIs/Drivers/Send igor command_no return.vi"/>
			<Item Name="Set PIDS loop 0.vi" Type="VI" URL="../subVIs/Drivers/Set PIDS loop 0.vi"/>
			<Item Name="Set PIDS loop 1.vi" Type="VI" URL="../subVIs/Drivers/Set PIDS loop 1.vi"/>
			<Item Name="Set value.vi" Type="VI" URL="../subVIs/Drivers/Set value.vi"/>
			<Item Name="SGL Wordswap.vi" Type="VI" URL="../subVIs/helper VIs/SGL Wordswap.vi"/>
			<Item Name="Stop PIS Loops.vi" Type="VI" URL="../subVIs/Drivers/Stop PIS Loops.vi"/>
			<Item Name="SVG Parser.vi" Type="VI" URL="../subVIs/parsing/SVG Parser.vi"/>
			<Item Name="Tip touchdown.vi" Type="VI" URL="../subVIs/Drivers/Tip touchdown.vi"/>
			<Item Name="Tip Withdraw.vi" Type="VI" URL="../subVIs/Drivers/Tip Withdraw.vi"/>
